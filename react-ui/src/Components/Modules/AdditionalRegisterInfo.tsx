...
const AdditionalRegisterInfo = (props: Modal) => {
  ...
  const formik = useFormik<AdditionalRegister>({
    ...
    validationSchema: Yup.object({
      ...
      end: Yup.number().positive("Please select your start year"),
      ...
      <div className="w-1/2 flex flex-col">
        <div className="bg-white p-2 rounded-3xl font-montserat">
          <form className="p-4" onSubmit={formik.handleSubmit}>
            ...
            <div className="flex flex-auto h-6">
              <div className="w-1/2">
...
export default AdditionalRegisterInfo;
