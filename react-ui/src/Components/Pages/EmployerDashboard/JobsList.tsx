    ...
    <Protected id={id!}>
      <section className="flex flex-col">
        ...
        <div className="flex justify-end items-center">
          <button className="btn-primary my-3 mx-3 bg-purple-400 hover:bg-purple-300">Edit Post</button>
          <button className="btn-primary my-3 mx-3 bg-lime-400 hover:bg-lime-300">Track Applicants</button>
        </div>
      </section>
    </Protected>
  );
...
const JobsList = ({ employerId }: JobsListProps) => {
  ...
  return (
    <div className="flex justify-center flex-col items-center">{content}</div>
  );
};
